<div class="inkfin-cosmetics calculator-column">
    ...
    <div class="inkfin-cosmetics" style="margin-left:24px; margin-right:24px;"><input
        ...
        <div style="width: 100%; text-align: center;">
            <button class="button button-primary" align="middle" id="sixMBtn">6 Months</button>
            <button class="button button-outline-primary" align="middle" id="twelveMBtn">12 Months</button>
        </div>
